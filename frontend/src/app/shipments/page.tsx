...
export default function ShipmentsPage() {
  ...
  const totalShipments = 2; // demo total shipments
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="mt-4">
        ...
        <div className="text-sm text-gray-700 dark:text-gray-300">
          Address: Guangzhou, Guangdong, China — 广州白云区西槎路同雅东街59号。同德仓库A3
        </div>
      ...
      <div className="mt-4">
        ...
        <div className="text-sm text-gray-700 dark:text-gray-300">
          cargo - By air | Company: MoveOn Global Shipping | Cost: 1150/kg
        </div>
